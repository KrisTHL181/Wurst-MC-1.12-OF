...
public final class AutoFarmMod extends Mod
	implements UpdateListener, RenderListener
{
	...
	public void onUpdate()
	{
		...
		if(!wurst.mods.freecamMod.isActive())
		{
			...
			blocksToReplant = getBlockStream(eyesBlock, blockRange)
				...
				.filter(pos -> WBlock.getMaterial(pos).isReplaceable())
	...
	private boolean shouldBeHarvested(BlockPos pos)
	{
		...
		if(block instanceof BlockCrops)
			...
			return WBlock.getBlock(pos.down()) instanceof BlockReed
				&& !(WBlock.getBlock(pos.down(2)) instanceof BlockReed);
	...
	private void registerPlants(List<BlockPos> blocks)
	{
		...
		plants.putAll(blocks.parallelStream()
			...
			.collect(Collectors.toMap(pos -> pos,
				pos -> seeds.get(WBlock.getBlock(pos)))));
	}
